...
export default function CTASection() {
  return (
    <section className="py-10 md:py-16 bg-(--bg) text-center relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        <h2 className="text-display-3 md:text-display-2 font-heading text-(--on-bg-high) mb-4">Следите за новостями проекта</h2>
        <p className="text-body-2 font-sans text-(--on-bg-medium) max-w-2xl mx-auto mb-6">Подпишитесь, чтобы получать обновления о новых экспозициях, датах показа и эксклюзивных событиях.</p>
